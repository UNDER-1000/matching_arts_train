    ...
    while True:
        try:
            async with get_connection() as session:
                ...
                logic = get_logic()
                sorted_ids = await logic.predict_artworks(
...
async def user_interaction(interaction: UserInteraction):
    ...
    if action == "like" or action == "dislike":
        ...
        logic = get_logic()
        return await logic.predict_walls(artwork_id, k=10)
